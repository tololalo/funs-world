...
class I18n {
    constructor() {
        // Load language from localStorage or detect from browser, default to Korean
        this.currentLang = localStorage.getItem('funs_language') ||
                          this.detectBrowserLanguage() || 'ko';

        // Fall back to Korean if language not supported
